:root {
  ...
  --container-sm: calc(var(--screen-sm-min) + var(--gutter-width));
  --container-md: calc(var(--screen-md-min) + var(--gutter-width));
  --container-lg: calc(var(--screen-lg-min) + var(--gutter-width));
}
